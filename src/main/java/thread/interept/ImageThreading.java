...
public class ImageThreading {
    public static final String SOURCE_FILE = "./src/many-flowers.jpg";
    public static final String DESTINATION_FILE = "./src/many-flowers_ver_1.jpg";
